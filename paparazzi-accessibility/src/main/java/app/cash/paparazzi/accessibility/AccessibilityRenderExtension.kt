...
import app.cash.paparazzi.accessibility.Colors.getColor
import java.awt.image.BufferedImage

class AccessibilityRenderExtension(private val renderSettings: RenderSettings = RenderSettings()) : RenderExtension {
