...
class PaparazziTestExtension(
  ...
  private fun prepare(context: ExtensionContext) {
  ...
  private fun forcePlatformSdkVersion(compileSdkVersion: Int) {
    ...
    val versionClass = try {
      PaparazziTestExtension::class.java.classLoader.loadClass("android.os.Build\$VERSION")
